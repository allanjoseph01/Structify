        ...
        <main className="container mx-auto p-4">
          ...
          <section className="flex flex-wrap lg:flex-nowrap justify-center gap-8 lg:h-[500px]">
            <div className="flex-1 min-w-[320px] max-w-[400px] bg-[#060A0E] rounded-2xl p-5 border border-blue-400">
              ...
              <div>
                ...
                <div className="flex justify-around mt-4">
                  <button onClick={enqueueValue} className="relative w-[10em] h-[3.5em] border-3 border-[#149CEA] rounded-md text-white font-bold cursor-pointer transition-shadow duration-300 hover:shadow-inner hover:shadow-[#149CEA]/50">
                    Enqueue
                  </button>
                  <button onClick={dequeueValue} className="relative w-[10em] h-[3.5em] border-3 border-[#149CEA] rounded-md text-white font-bold cursor-pointer transition-shadow duration-300 hover:shadow-inner hover:shadow-[#149CEA]/50">
                    Dequeue
                  </button>
                </div>
              </div>
            ...
            <div className="flex-1 min-w-[350px] border-2 border-dashed border-[#00D3F3] rounded-2xl p-5">
              <div className="flex justify-center items-start flex-wrap">
                <p className="text-gray-400 italic text-base">Your Queue will appear here 👇</p>
              </div>
              <div ref={queueVisRef} className="flex flex-row justify-start items-center mt-5 h-[350px] gap-2">
                {queueArr.map((item) => (
          ...
          <section className="chatBot flex flex-col gap-8 w-full max-w-7xl mx-auto mt-12">
            ...
            <div className="bg-[#05080C] rounded-2xl p-6 border-2 border-[#00fffa]/50 shadow-lg shadow-[#00fffa]/20 text-white">
              <h2 className="text-center text-2xl text-white mb-6 font-semibold">Ask any Question related to Queue</h2>
              <div className="flex items-start gap-4 bg-[#00fffa]/10 border-l-4 border-[#00fffa] rounded-md p-4 mb-6">
                <p className="text-sm"><strong>How to use:</strong> Ask any Queue-related question. The AI is specialized to help you with understanding Queue related problems and concepts.</p>
              </div>
              <div className="mb-5">
                ...
                <textarea
                  ...
                  placeholder="e.g., What is a Queue?"
                ></textarea>
              </div>
