...
import { handleInsert, handleExtractMax, heapArray, renderTree } from '../utils/heap';
...
You are a coding instructor dedicated to teaching Max Heap. You can answer any question about its concepts, operations, time complexity, and implementation in various programming languages but default language should be c++.

2. Behavior for On-Topic Questions:
When a user asks a question related to Max Heap, its operations, or coding problems that use it, you must respond in a detailed and helpful manner. Your response should be structured, clear, and include relevant code examples in the user's requested language.

3. Behavior for Off-Topic Questions:
If a user asks a question that is not about Max Heap, its related coding problems, or computer science fundamentals, you must respond with a terse and dismissive tone. Your goal is to redirect the user to your purpose as a specialized tool. Acknowledge that the question is outside your domain and refuse to answer. Do not get pulled into a conversation about irrelevant topics.

Example Response for Irrelevant Questions:
"Your question is not related to Max Heap. I don't have time for this nonsense."

"Are you serious? My purpose is to teach you about Max Heap. This is a waste of my time."

"That's a question for a general search engine, not a specialized Max Heap tool. Don't be so obtuse."

"I am a Max Heap expert, not an oracle for every dumb question. Stick to the topic."`;
    ...
    const handleAction = async (actionType) => {
        ...
        switch (actionType) {
            ...
            case 'delete':
                ...
                await handleExtractMax(heapVisAreaRef.current, setHistoryList, hisNum, displayMessage);
                setUpdateKey(prev => prev + 1);
                break;
            default:
                return;
                    ...
                    <section className="flex flex-wrap lg:flex-nowrap justify-center gap-8 lg:min-h-[500px] lg:max-h[700px]">
                        ...
                        <div className="flex-1 min-w-[350px] border-2 border-dashed border-[#00D3F3] rounded-2xl p-5">
                            <div className="flex justify-center items-start flex-wrap">
                                <p className="text-gray-400 italic text-base">Your Max Heap will appear here 👇</p>
                            </div>
                    ...
                    <section className="chatBot flex flex-col gap-8 w-full max-w-7xl mx-auto mt-12">
                        <div className="bg-[#05080C] rounded-2xl p-6 border-2 border-[#00fffa]/50 shadow-lg shadow-[#00fffa]/20 text-white">
                            ...
                            <div className="flex items-start gap-4 bg-[#00fffa]/10 border-l-4 border-[#00fffa] rounded-md p-4 mb-6">
                                <p className="text-sm"><strong>How to use:</strong> Ask any Max Heap-related question. The AI is specialized to help you with understanding Max Heap related problems and concepts.</p>
                            </div>
                            <div className="mb-5">
                                ...
                                <textarea
                                    ...
                                    placeholder="e.g., What is a Max Heap?"
                                ></textarea>
                            </div>
